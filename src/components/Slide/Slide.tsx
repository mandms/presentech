...
function Slide({ slide, isPreview }: ISlideProps): JSX.Element {
  //const previewClass = isPreview ? styles.preview : styles.slide;
  return (
    <svg className={styles.slide} xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1001 563" fill="none">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
